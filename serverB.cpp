...
int main(int argc, char *argv[]) {
    ...
    map<char, struct map_info> all_maps = load_map("map2.txt");
    ...
    if ((rv = getaddrinfo(IP, B_PORT, &hints, &servinfo)) != 0) { 
    ...
    while (1) {
        ...
        printf("The Server B has received input for finding graph of %c\n", query_map_id);
